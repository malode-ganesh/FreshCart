	...
	<nav>
		<div class="nav nav-tabs" id="nav-tab" role="tablist">
			<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"
				aria-controls="nav-home" aria-selected="true">Upload Documents <i class="fa-solid fa-arrow-up-from-bracket"></i></a>
			...
			<a class="nav-item nav-link" id="nav-notice-tab" data-toggle="tab" href="#nav-notice" role="tab"
				aria-controls="nav-notice-tab" aria-selected="false">
				Upload Notices <i style="width:3em" class="fa fa-bell fa-solid fa-bounce" aria-hidden="true"></i>
				</a>
		</div>
	</nav>
