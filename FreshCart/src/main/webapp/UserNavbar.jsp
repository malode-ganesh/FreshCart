...
<body class="container-fluid">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<a class="navbar-brand" href="UserDashboard.jsp"> <img src="images/freshCartLogo-2.png" alt="FreshKart" width="120px">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<button class="btn btn-sm btn-dark mt-1" onClick="displayResult()"><i class="fa-solid fa-square-poll-vertical"></i> Result</button>
				</li>
				...
				<li class="nav-item"><a class="nav-link " href="adminLogin.jsp"><i class="fa-regular fa-circle-up"></i>hjhfhgf</a></li>
			</ul>
