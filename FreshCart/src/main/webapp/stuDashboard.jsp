...
<body>
	...
	<div class="card">
		<div class="card-header p-2">
			<h5>
				<i class="fa-solid fa-user-large fa-beat-fade"></i> Welcome
				<%=user1.getName().toUpperCase()%></h5>
			<h5>
				<i class="fa-solid fa-book fa-beat-fade"></i> Course :<%=user1.getCourse().toUpperCase()%></h5>
		</div>
	</div>
	<!-- card close -->
	<hr>
		...
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				...
				<button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#myModal">
					Notices<i style="width:3em" class="fa fa-bell fa-solid fa-bounce" aria-hidden="true"></i>
				</button>
			</div>
		</nav>
