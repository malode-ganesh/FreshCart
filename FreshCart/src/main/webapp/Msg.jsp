...
%>
  ...
  <%
      ...
      <tr>
        ...
        <td><form action="downloadFiles" method="post" >
        ...
        <td><form action="FileReadPdf" method="post" >
        	<input type="text" name="uploadFileName" value="<%out.print(fileName);%>" hidden>
  ...
  <button class="btn btn-sm btn-primary" value="Back" type="Button" onclick="history.go(-1);">BACK</button>
  	</div>
  	<div class="col-md-2"></div>
  </div>
